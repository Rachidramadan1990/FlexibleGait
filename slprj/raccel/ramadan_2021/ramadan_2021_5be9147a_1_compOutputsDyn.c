...
. mValues ; const int * rtdvi = rtdv -> mInts . mValues ; int ii [ 2 ] ;
double xx [ 487 ] ; ( void ) rtdvd ; ( void ) rtdvi ; ( void ) eqnEnableFlags
; ( void ) modeVector ; ( void ) inputDot ; ( void ) inputDdot ; ( void )
discreteState ; ( void ) neDiagMgr ; ( void ) derivErr ; xx [ 0 ] = state [ 3
] ; xx [ 1 ] = state [ 4 ] ; xx [ 2 ] = state [ 5 ] ; xx [ 3 ] = state [ 6 ]
; xx [ 4 ] = state [ 10 ] ; xx [ 5 ] = state [ 11 ] ; xx [ 6 ] = state [ 12 ]
; pm_math_Quaternion_compDeriv_ra ( xx + 0 , xx + 4 , xx + 7 ) ; xx [ 0 ] =
1.0 ; xx [ 1 ] = 2.0 ; xx [ 2 ] = state [ 5 ] * state [ 5 ] ; xx [ 3 ] =
state [ 6 ] * state [ 6 ] ; xx [ 11 ] = xx [ 0 ] - xx [ 1 ] * ( xx [ 2 ] + xx
[ 3 ] ) ; xx [ 12 ] = state [ 4 ] * state [ 5 ] ; xx [ 13 ] = state [ 3 ] *
state [ 6 ] ; xx [ 14 ] = xx [ 1 ] * ( xx [ 12 ] - xx [ 13 ] ) ; xx [ 15 ] =
state [ 3 ] * state [ 5 ] ; xx [ 16 ] = state [ 4 ] * state [ 6 ] ; xx [ 17 ]
= xx [ 1 ] * ( xx [ 15 ] + xx [ 16 ] ) ; xx [ 18 ] = xx [ 11 ] ; xx [ 19 ] =
xx [ 14 ] ; xx [ 20 ] = xx [ 17 ] ; xx [ 21 ] = 53.5 ; xx [ 22 ] = 0.5 ; xx [
23 ] = xx [ 22 ] * state [ 22 ] ; xx [ 24 ] = cos ( xx [ 23 ] ) ; xx [ 25 ] =
xx [ 22 ] * state [ 21 ] ; xx [ 26 ] = sin ( xx [ 25 ] ) ; xx [ 27 ] = xx [
24 ] * xx [ 26 ] ; xx [ 28 ] = xx [ 27 ] * xx [ 27 ] ; xx [ 29 ] = sin ( xx [
23 ] ) ; xx [ 30 ] = xx [ 26 ] * xx [ 29 ] ; xx [ 26 ] = cos ( xx [ 25 ] ) ;
xx [ 25 ] = xx [ 26 ] * xx [ 29 ] ; xx [ 31 ] = xx [ 25 ] * xx [ 30 ] ; xx [
32 ] = xx [ 26 ] * xx [ 24 ] ; xx [ 26 ] = xx [ 32 ] * xx [ 27 ] ; xx [ 33 ]
= xx [ 32 ] * xx [ 30 ] ; xx [ 34 ] = xx [ 25 ] * xx [ 27 ] ; xx [ 35 ] = xx
[ 32 ] * xx [ 25 ] ; xx [ 36 ] = xx [ 27 ] * xx [ 30 ] ; xx [ 37 ] = xx [ 1 ]
* ( xx [ 28 ] + xx [ 30 ] * xx [ 30 ] ) - xx [ 0 ] ; xx [ 38 ] = xx [ 1 ] * (
xx [ 31 ] - xx [ 26 ] ) ; xx [ 39 ] = xx [ 1 ] * ( xx [ 33 ] + xx [ 34 ] ) ;
xx [ 40 ] = xx [ 1 ] * ( xx [ 31 ] + xx [ 26 ] ) ; xx [ 41 ] = xx [ 1 ] * (
xx [ 28 ] + xx [ 25 ] * xx [ 25 ] ) - xx [ 0 ] ; xx [ 42 ] = xx [ 1 ] * ( xx
[ 35 ] - xx [ 36 ] ) ; xx [ 43 ] = xx [ 1 ] * ( xx [ 33 ] - xx [ 34 ] ) ; xx
[ 44 ] = xx [ 1 ] * ( xx [ 35 ] + xx [ 36 ] ) ; xx [ 45 ] = xx [ 1 ] * ( xx [
28 ] + xx [ 32 ] * xx [ 32 ] ) - xx [ 0 ] ; xx [ 26 ] = 8.5 ; xx [ 28 ] = xx
[ 22 ] * state [ 25 ] ; xx [ 31 ] = sin ( xx [ 28 ] ) ; xx [ 33 ] = xx [ 31 ]
* xx [ 31 ] ; xx [ 34 ] = xx [ 1 ] * xx [ 33 ] - xx [ 0 ] ; xx [ 35 ] = 3.5 ;
xx [ 36 ] = 0.7061939498602465 ; xx [ 46 ] = xx [ 22 ] * state [ 27 ] ; xx [
47 ] = sin ( xx [ 46 ] ) ; xx [ 48 ] = 0.7080184356221128 ; xx [ 49 ] = cos (
xx [ 46 ] ) ; xx [ 46 ] = xx [ 36 ] * xx [ 47 ] - xx [ 48 ] * xx [ 49 ] ; xx
[ 50 ] = xx [ 46 ] * xx [ 46 ] ; xx [ 51 ] = xx [ 1 ] * xx [ 50 ] - xx [ 0 ]
; xx [ 52 ] = 1.254 ; xx [ 53 ] = 0.01275483281592086 ; xx [ 54 ] =
5.705000000159994e-3 ; ii [ 0 ] = factorSymmetricPosDef ( xx + 54 , 1 , xx +
55 ) ; ii [ 1 ] = ii [ 0 ] != 0 ? 1 : 0 ; if ( ii [ 1 ] != 0 ) * derivErr = 1
; memcpy ( xx + 55 , xx + 54 , 1 * sizeof ( double ) ) ; xx [ 56 ] = xx [ 53
] / xx [ 55 ] ; xx [ 57 ] = xx [ 52 ] - xx [ 53 ] * xx [ 56 ] ; xx [ 58 ] =
0.02527299427922832 ; xx [ 59 ] = xx [ 58 ] * xx [ 56 ] ; xx [ 60 ] = xx [ 48
] * xx [ 47 ] + xx [ 36 ] * xx [ 49 ] ; xx [ 47 ] = xx [ 1 ] * xx [ 46 ] * xx
[ 60 ] ; xx [ 49 ] = xx [ 59 ] * xx [ 47 ] ; xx [ 61 ] = xx [ 57 ] * xx [ 51
] - xx [ 49 ] ; xx [ 62 ] = xx [ 59 ] * xx [ 51 ] ; xx [ 59 ] = xx [ 58 ] /
xx [ 55 ] ; xx [ 63 ] = xx [ 52 ] - xx [ 58 ] * xx [ 59 ] ; xx [ 64 ] = xx [
62 ] - xx [ 47 ] * xx [ 63 ] ; xx [ 65 ] = xx [ 51 ] * xx [ 61 ] - xx [ 47 ]
* xx [ 64 ] ; xx [ 66 ] = xx [ 35 ] + xx [ 65 ] ; xx [ 67 ] = 0.18 ; xx [ 68
] = xx [ 1 ] * ( xx [ 50 ] + xx [ 60 ] * xx [ 60 ] ) - xx [ 0 ] ; xx [ 50 ] =
5.065917065550745e-3 ; xx [ 69 ] = xx [ 50 ] * xx [ 59 ] ; xx [ 70 ] = xx [
50 ] * xx [ 56 ] ; xx [ 71 ] = xx [ 68 ] * ( xx [ 69 ] * xx [ 47 ] + xx [ 70
] * xx [ 51 ] ) ; xx [ 72 ] = xx [ 63 ] * xx [ 51 ] + xx [ 49 ] ; xx [ 49 ] =
xx [ 47 ] * xx [ 57 ] + xx [ 62 ] ; xx [ 57 ] = xx [ 47 ] * xx [ 72 ] - xx [
51 ] * xx [ 49 ] ; xx [ 62 ] = 0.01017131803502461 ; xx [ 63 ] = xx [ 62 ] *
xx [ 60 ] ; xx [ 73 ] = 0.02015390293399388 ; xx [ 74 ] = xx [ 73 ] * xx [ 60
] ; xx [ 75 ] = xx [ 1 ] * ( xx [ 63 ] * xx [ 46 ] + xx [ 74 ] * xx [ 60 ] )
- xx [ 73 ] ; xx [ 76 ] = 0.2901713180350247 ; xx [ 77 ] = xx [ 76 ] + xx [ 1
] * ( xx [ 74 ] * xx [ 46 ] - xx [ 63 ] * xx [ 60 ] ) ; xx [ 63 ] = xx [ 57 ]
* xx [ 75 ] - xx [ 77 ] * xx [ 65 ] ; xx [ 65 ] = xx [ 71 ] + xx [ 63 ] ; xx
[ 74 ] = xx [ 67 ] * xx [ 66 ] - xx [ 65 ] ; xx [ 78 ] = 0.05 ; xx [ 79 ] =
xx [ 50 ] / xx [ 55 ] ; xx [ 80 ] = xx [ 68 ] * ( xx [ 69 ] * xx [ 51 ] - xx
[ 70 ] * xx [ 47 ] ) ; xx [ 69 ] = xx [ 71 ] * xx [ 77 ] - xx [ 80 ] * xx [
75 ] ; xx [ 70 ] = xx [ 47 ] * xx [ 61 ] + xx [ 51 ] * xx [ 64 ] ; xx [ 61 ]
= xx [ 47 ] * xx [ 49 ] + xx [ 51 ] * xx [ 72 ] ; xx [ 49 ] = xx [ 70 ] * xx
[ 77 ] + xx [ 75 ] * xx [ 61 ] ; xx [ 64 ] = xx [ 78 ] + ( xx [ 50 ] - xx [
50 ] * xx [ 79 ] ) * xx [ 68 ] * xx [ 68 ] - xx [ 69 ] - xx [ 69 ] + xx [ 75
] * xx [ 49 ] - xx [ 77 ] * xx [ 63 ] ; xx [ 63 ] = xx [ 64 ] - xx [ 67 ] *
xx [ 65 ] ; xx [ 69 ] = xx [ 63 ] + xx [ 67 ] * xx [ 74 ] ; ii [ 0 ] =
factorSymmetricPosDef ( xx + 69 , 1 , xx + 71 ) ; if ( ii [ 0 ] != 0 ? 1 : 0
!= 0 ) * derivErr = 1 ; xx [ 71 ] = xx [ 74 ] / xx [ 69 ] ; xx [ 72 ] = xx [
66 ] - xx [ 74 ] * xx [ 71 ] ; xx [ 81 ] = cos ( xx [ 28 ] ) ; xx [ 28 ] = xx
[ 1 ] * xx [ 81 ] * xx [ 31 ] ; xx [ 82 ] = xx [ 80 ] + xx [ 49 ] ; xx [ 49 ]
= xx [ 67 ] * xx [ 70 ] + xx [ 82 ] ; xx [ 80 ] = xx [ 49 ] * xx [ 71 ] ; xx
[ 83 ] = xx [ 57 ] + xx [ 80 ] ; xx [ 84 ] = xx [ 34 ] * xx [ 72 ] + xx [ 28
] * xx [ 83 ] ; xx [ 85 ] = xx [ 80 ] - xx [ 70 ] ; xx [ 80 ] = xx [ 35 ] +
xx [ 61 ] ; xx [ 61 ] = xx [ 49 ] / xx [ 69 ] ; xx [ 86 ] = xx [ 80 ] - xx [
49 ] * xx [ 61 ] ; xx [ 87 ] = xx [ 34 ] * xx [ 85 ] + xx [ 28 ] * xx [ 86 ]
; xx [ 88 ] = xx [ 34 ] * xx [ 84 ] + xx [ 28 ] * xx [ 87 ] ; xx [ 89 ] = xx
[ 26 ] + xx [ 88 ] ; xx [ 90 ] = 0.16 ; xx [ 91 ] = - xx [ 23 ] ; xx [ 23 ] =
sin ( xx [ 91 ] ) ; xx [ 92 ] = xx [ 1 ] * xx [ 23 ] * xx [ 23 ] - xx [ 0 ] ;
xx [ 93 ] = xx [ 90 ] * xx [ 92 ] ; xx [ 94 ] = xx [ 1 ] * ( xx [ 33 ] + xx [
81 ] * xx [ 81 ] ) - xx [ 0 ] ; xx [ 33 ] = xx [ 65 ] + xx [ 63 ] * xx [ 71 ]
; xx [ 95 ] = xx [ 82 ] - xx [ 63 ] * xx [ 61 ] ; xx [ 96 ] = xx [ 94 ] * (
xx [ 34 ] * xx [ 33 ] + xx [ 28 ] * xx [ 95 ] ) ; xx [ 97 ] = xx [ 67 ] * xx
[ 81 ] ; xx [ 98 ] = 0.48 ; xx [ 99 ] = xx [ 1 ] * xx [ 97 ] * xx [ 81 ] - xx
[ 98 ] ; xx [ 100 ] = xx [ 1 ] * xx [ 97 ] * xx [ 31 ] ; xx [ 97 ] = xx [ 34
] * xx [ 83 ] - xx [ 28 ] * xx [ 72 ] ; xx [ 72 ] = xx [ 34 ] * xx [ 86 ] -
xx [ 28 ] * xx [ 85 ] ; xx [ 83 ] = xx [ 34 ] * xx [ 97 ] + xx [ 28 ] * xx [
72 ] ; xx [ 85 ] = xx [ 99 ] * xx [ 88 ] + xx [ 100 ] * xx [ 83 ] ; xx [ 86 ]
...
, 2 , xx + 121 ) ; if ( ii [ 0 ] != 0 ? 1 : 0 != 0 ) * derivErr = 1 ; xx [
106 ] = xx [ 34 ] * xx [ 47 ] + xx [ 28 ] * xx [ 112 ] + xx [ 51 ] + xx [ 94
] + xx [ 115 ] * xx [ 99 ] ; xx [ 28 ] = xx [ 101 ] * xx [ 106 ] ; xx [ 34 ]
= 0.0 ; xx [ 47 ] = xx [ 119 ] + xx [ 72 ] ; xx [ 51 ] = xx [ 47 ] * xx [ 92
] - xx [ 93 ] * xx [ 95 ] ; xx [ 72 ] = xx [ 101 ] * xx [ 120 ] ; xx [ 128 ]
= xx [ 28 ] ; xx [ 129 ] = xx [ 85 ] ; xx [ 130 ] = xx [ 109 ] ; xx [ 131 ] =
xx [ 108 ] ; xx [ 132 ] = xx [ 33 ] ; xx [ 133 ] = xx [ 34 ] ; xx [ 134 ] =
xx [ 88 ] ; xx [ 135 ] = xx [ 34 ] ; xx [ 136 ] = - xx [ 51 ] ; xx [ 137 ] =
xx [ 34 ] ; xx [ 138 ] = xx [ 72 ] ; xx [ 139 ] = xx [ 97 ] ;
solveSymmetricPosDef ( xx + 124 , xx + 128 , 2 , 6 , xx + 140 , xx + 121 ) ;
xx [ 94 ] = xx [ 51 ] * xx [ 146 ] ; xx [ 112 ] = - ( xx [ 72 ] * xx [ 146 ]
+ xx [ 97 ] * xx [ 147 ] ) ; xx [ 115 ] = xx [ 26 ] + xx [ 84 ] ; xx [ 84 ] =
- ( xx [ 72 ] * xx [ 148 ] + xx [ 97 ] * xx [ 149 ] ) ; xx [ 128 ] = xx [ 89
] - xx [ 88 ] * xx [ 146 ] ; xx [ 129 ] = xx [ 83 ] + xx [ 94 ] ; xx [ 130 ]
= xx [ 112 ] ; xx [ 131 ] = xx [ 95 ] + xx [ 94 ] ; xx [ 132 ] = xx [ 115 ] +
xx [ 51 ] * xx [ 148 ] ; xx [ 133 ] = xx [ 84 ] ; xx [ 134 ] = xx [ 112 ] ;
xx [ 135 ] = xx [ 84 ] ; xx [ 136 ] = xx [ 96 ] - ( xx [ 72 ] * xx [ 150 ] +
xx [ 97 ] * xx [ 151 ] ) ; pm_math_Matrix3x3_composeTranspose_ra ( xx + 128 ,
xx + 37 , xx + 152 ) ; pm_math_Matrix3x3_compose_ra ( xx + 37 , xx + 152 , xx
+ 128 ) ; xx [ 84 ] = xx [ 22 ] * state [ 14 ] ; xx [ 94 ] = cos ( xx [ 84 ]
) ; xx [ 112 ] = xx [ 22 ] * state [ 13 ] ; xx [ 119 ] = sin ( xx [ 112 ] ) ;
xx [ 121 ] = xx [ 94 ] * xx [ 119 ] ; xx [ 122 ] = xx [ 121 ] * xx [ 121 ] ;
xx [ 137 ] = sin ( xx [ 84 ] ) ; xx [ 138 ] = xx [ 119 ] * xx [ 137 ] ; xx [
119 ] = cos ( xx [ 112 ] ) ; xx [ 112 ] = xx [ 119 ] * xx [ 137 ] ; xx [ 139
] = xx [ 112 ] * xx [ 138 ] ; xx [ 152 ] = xx [ 119 ] * xx [ 94 ] ; xx [ 119
] = xx [ 152 ] * xx [ 121 ] ; xx [ 153 ] = xx [ 152 ] * xx [ 138 ] ; xx [ 154
] = xx [ 112 ] * xx [ 121 ] ; xx [ 155 ] = xx [ 152 ] * xx [ 112 ] ; xx [ 156
] = xx [ 121 ] * xx [ 138 ] ; xx [ 157 ] = xx [ 1 ] * ( xx [ 122 ] + xx [ 138
] * xx [ 138 ] ) - xx [ 0 ] ; xx [ 158 ] = xx [ 1 ] * ( xx [ 139 ] - xx [ 119
] ) ; xx [ 159 ] = xx [ 1 ] * ( xx [ 153 ] + xx [ 154 ] ) ; xx [ 160 ] = xx [
1 ] * ( xx [ 139 ] + xx [ 119 ] ) ; xx [ 161 ] = xx [ 1 ] * ( xx [ 122 ] + xx
[ 112 ] * xx [ 112 ] ) - xx [ 0 ] ; xx [ 162 ] = xx [ 1 ] * ( xx [ 155 ] - xx
[ 156 ] ) ; xx [ 163 ] = xx [ 1 ] * ( xx [ 153 ] - xx [ 154 ] ) ; xx [ 164 ]
= xx [ 1 ] * ( xx [ 155 ] + xx [ 156 ] ) ; xx [ 165 ] = xx [ 1 ] * ( xx [ 122
] + xx [ 152 ] * xx [ 152 ] ) - xx [ 0 ] ; xx [ 119 ] = xx [ 22 ] * state [
17 ] ; xx [ 122 ] = sin ( xx [ 119 ] ) ; xx [ 139 ] = xx [ 122 ] * xx [ 122 ]
; xx [ 153 ] = xx [ 1 ] * xx [ 139 ] - xx [ 0 ] ; xx [ 154 ] = xx [ 22 ] *
state [ 19 ] ; xx [ 22 ] = sin ( xx [ 154 ] ) ; xx [ 155 ] = cos ( xx [ 154 ]
) ; xx [ 154 ] = xx [ 36 ] * xx [ 22 ] - xx [ 48 ] * xx [ 155 ] ; xx [ 156 ]
= xx [ 154 ] * xx [ 154 ] ; xx [ 166 ] = xx [ 1 ] * xx [ 156 ] - xx [ 0 ] ;
if ( ii [ 1 ] != 0 ) * derivErr = 1 ; xx [ 167 ] = xx [ 53 ] / xx [ 54 ] ; xx
[ 168 ] = xx [ 52 ] - xx [ 53 ] * xx [ 167 ] ; xx [ 169 ] = xx [ 58 ] * xx [
167 ] ; xx [ 170 ] = xx [ 48 ] * xx [ 22 ] + xx [ 36 ] * xx [ 155 ] ; xx [ 22
] = xx [ 1 ] * xx [ 154 ] * xx [ 170 ] ; xx [ 36 ] = xx [ 169 ] * xx [ 22 ] ;
xx [ 48 ] = xx [ 168 ] * xx [ 166 ] - xx [ 36 ] ; xx [ 155 ] = xx [ 169 ] *
xx [ 166 ] ; xx [ 169 ] = xx [ 58 ] / xx [ 54 ] ; xx [ 171 ] = xx [ 52 ] - xx
[ 58 ] * xx [ 169 ] ; xx [ 172 ] = xx [ 155 ] - xx [ 22 ] * xx [ 171 ] ; xx [
173 ] = xx [ 166 ] * xx [ 48 ] - xx [ 22 ] * xx [ 172 ] ; xx [ 174 ] = xx [
35 ] + xx [ 173 ] ; xx [ 175 ] = xx [ 1 ] * ( xx [ 156 ] + xx [ 170 ] * xx [
170 ] ) - xx [ 0 ] ; xx [ 156 ] = xx [ 50 ] * xx [ 169 ] ; xx [ 176 ] = xx [
50 ] * xx [ 167 ] ; xx [ 177 ] = xx [ 175 ] * ( xx [ 156 ] * xx [ 22 ] + xx [
176 ] * xx [ 166 ] ) ; xx [ 178 ] = xx [ 171 ] * xx [ 166 ] + xx [ 36 ] ; xx
[ 36 ] = xx [ 22 ] * xx [ 168 ] + xx [ 155 ] ; xx [ 155 ] = xx [ 22 ] * xx [
178 ] - xx [ 166 ] * xx [ 36 ] ; xx [ 168 ] = xx [ 62 ] * xx [ 170 ] ; xx [
171 ] = xx [ 73 ] * xx [ 170 ] ; xx [ 179 ] = xx [ 1 ] * ( xx [ 168 ] * xx [
154 ] + xx [ 171 ] * xx [ 170 ] ) - xx [ 73 ] ; xx [ 180 ] = xx [ 76 ] + xx [
1 ] * ( xx [ 171 ] * xx [ 154 ] - xx [ 168 ] * xx [ 170 ] ) ; xx [ 76 ] = xx
[ 155 ] * xx [ 179 ] - xx [ 180 ] * xx [ 173 ] ; xx [ 168 ] = xx [ 177 ] + xx
[ 76 ] ; xx [ 171 ] = xx [ 67 ] * xx [ 174 ] - xx [ 168 ] ; xx [ 173 ] = xx [
50 ] / xx [ 54 ] ; xx [ 181 ] = xx [ 175 ] * ( xx [ 156 ] * xx [ 166 ] - xx [
176 ] * xx [ 22 ] ) ; xx [ 156 ] = xx [ 177 ] * xx [ 180 ] - xx [ 181 ] * xx
[ 179 ] ; xx [ 176 ] = xx [ 22 ] * xx [ 48 ] + xx [ 166 ] * xx [ 172 ] ; xx [
48 ] = xx [ 22 ] * xx [ 36 ] + xx [ 166 ] * xx [ 178 ] ; xx [ 36 ] = xx [ 176
] * xx [ 180 ] + xx [ 179 ] * xx [ 48 ] ; xx [ 172 ] = xx [ 78 ] + ( xx [ 50
] - xx [ 50 ] * xx [ 173 ] ) * xx [ 175 ] * xx [ 175 ] - xx [ 156 ] - xx [
156 ] + xx [ 179 ] * xx [ 36 ] - xx [ 180 ] * xx [ 76 ] ; xx [ 76 ] = xx [
172 ] - xx [ 67 ] * xx [ 168 ] ; xx [ 156 ] = xx [ 76 ] + xx [ 67 ] * xx [
171 ] ; ii [ 0 ] = factorSymmetricPosDef ( xx + 156 , 1 , xx + 177 ) ; if (
ii [ 0 ] != 0 ? 1 : 0 != 0 ) * derivErr = 1 ; xx [ 177 ] = xx [ 171 ] / xx [
156 ] ; xx [ 178 ] = xx [ 174 ] - xx [ 171 ] * xx [ 177 ] ; xx [ 182 ] = cos
( xx [ 119 ] ) ; xx [ 119 ] = xx [ 1 ] * xx [ 182 ] * xx [ 122 ] ; xx [ 183 ]
= xx [ 181 ] + xx [ 36 ] ; xx [ 36 ] = xx [ 67 ] * xx [ 176 ] + xx [ 183 ] ;
xx [ 181 ] = xx [ 36 ] * xx [ 177 ] ; xx [ 184 ] = xx [ 155 ] + xx [ 181 ] ;
xx [ 185 ] = xx [ 153 ] * xx [ 178 ] + xx [ 119 ] * xx [ 184 ] ; xx [ 186 ] =
xx [ 181 ] - xx [ 176 ] ; xx [ 181 ] = xx [ 35 ] + xx [ 48 ] ; xx [ 48 ] = xx
[ 36 ] / xx [ 156 ] ; xx [ 187 ] = xx [ 181 ] - xx [ 36 ] * xx [ 48 ] ; xx [
188 ] = xx [ 153 ] * xx [ 186 ] + xx [ 119 ] * xx [ 187 ] ; xx [ 189 ] = xx [
153 ] * xx [ 185 ] + xx [ 119 ] * xx [ 188 ] ; xx [ 190 ] = xx [ 26 ] + xx [
189 ] ; xx [ 191 ] = - xx [ 84 ] ; xx [ 84 ] = sin ( xx [ 191 ] ) ; xx [ 192
] = xx [ 1 ] * xx [ 84 ] * xx [ 84 ] - xx [ 0 ] ; xx [ 193 ] = xx [ 90 ] * xx
[ 192 ] ; xx [ 194 ] = xx [ 1 ] * ( xx [ 139 ] + xx [ 182 ] * xx [ 182 ] ) -
xx [ 0 ] ; xx [ 139 ] = xx [ 168 ] + xx [ 76 ] * xx [ 177 ] ; xx [ 195 ] = xx
[ 183 ] - xx [ 76 ] * xx [ 48 ] ; xx [ 196 ] = xx [ 194 ] * ( xx [ 153 ] * xx
[ 139 ] + xx [ 119 ] * xx [ 195 ] ) ; xx [ 197 ] = xx [ 67 ] * xx [ 182 ] ;
xx [ 198 ] = xx [ 1 ] * xx [ 197 ] * xx [ 182 ] - xx [ 98 ] ; xx [ 98 ] = xx
[ 1 ] * xx [ 197 ] * xx [ 122 ] ; xx [ 197 ] = xx [ 153 ] * xx [ 184 ] - xx [
119 ] * xx [ 178 ] ; xx [ 178 ] = xx [ 153 ] * xx [ 187 ] - xx [ 119 ] * xx [
186 ] ; xx [ 184 ] = xx [ 153 ] * xx [ 197 ] + xx [ 119 ] * xx [ 178 ] ; xx [
186 ] = xx [ 198 ] * xx [ 189 ] + xx [ 98 ] * xx [ 184 ] ; xx [ 187 ] = xx [
196 ] + xx [ 186 ] ; xx [ 189 ] = xx [ 193 ] * xx [ 190 ] - xx [ 187 ] * xx [
192 ] ; xx [ 199 ] = xx [ 1 ] * cos ( xx [ 191 ] ) * xx [ 84 ] ; xx [ 84 ] =
xx [ 102 ] * xx [ 22 ] ; xx [ 191 ] = xx [ 104 ] * xx [ 166 ] ; xx [ 200 ] =
xx [ 52 ] * xx [ 175 ] * xx [ 175 ] ; xx [ 175 ] = xx [ 200 ] * xx [ 179 ] ;
xx [ 201 ] = xx [ 91 ] + xx [ 84 ] * xx [ 22 ] + xx [ 191 ] * xx [ 166 ] + xx
[ 175 ] * xx [ 179 ] ; xx [ 202 ] = xx [ 104 ] * xx [ 22 ] ; xx [ 203 ] = xx
[ 102 ] * xx [ 166 ] ; xx [ 204 ] = xx [ 200 ] * xx [ 180 ] ; xx [ 205 ] = xx
[ 202 ] * xx [ 166 ] - xx [ 203 ] * xx [ 22 ] - xx [ 204 ] * xx [ 179 ] ; xx
[ 206 ] = xx [ 153 ] * xx [ 201 ] - xx [ 119 ] * xx [ 205 ] ; xx [ 207 ] = xx
[ 191 ] * xx [ 22 ] - xx [ 84 ] * xx [ 166 ] - xx [ 175 ] * xx [ 180 ] ; xx [
84 ] = xx [ 78 ] + xx [ 203 ] * xx [ 166 ] + xx [ 202 ] * xx [ 22 ] + xx [
204 ] * xx [ 180 ] ; xx [ 22 ] = xx [ 153 ] * xx [ 207 ] - xx [ 119 ] * xx [
84 ] ; xx [ 166 ] = xx [ 175 ] * xx [ 194 ] ; xx [ 191 ] = xx [ 204 ] * xx [
194 ] ; xx [ 202 ] = xx [ 166 ] * xx [ 153 ] + xx [ 119 ] * xx [ 191 ] ; xx [
203 ] = xx [ 98 ] * xx [ 202 ] ; xx [ 208 ] = xx [ 35 ] + xx [ 200 ] ; xx [
35 ] = xx [ 194 ] * xx [ 208 ] * xx [ 194 ] ; xx [ 200 ] = xx [ 98 ] * xx [
35 ] ; xx [ 209 ] = xx [ 23 ] + xx [ 153 ] * xx [ 206 ] - xx [ 119 ] * xx [
22 ] + xx [ 203 ] + xx [ 203 ] + xx [ 98 ] * xx [ 200 ] ; xx [ 203 ] = xx [
199 ] * xx [ 209 ] ; xx [ 210 ] = 0.15 ; xx [ 211 ] = xx [ 76 ] / xx [ 156 ]
; xx [ 212 ] = xx [ 194 ] * ( xx [ 153 ] * xx [ 195 ] - xx [ 119 ] * xx [ 139
] ) ; xx [ 139 ] = xx [ 196 ] * xx [ 198 ] + xx [ 98 ] * xx [ 212 ] ; xx [
195 ] = xx [ 153 ] * xx [ 188 ] - xx [ 119 ] * xx [ 185 ] ; xx [ 185 ] = xx [
153 ] * xx [ 178 ] - xx [ 119 ] * xx [ 197 ] ; xx [ 178 ] = xx [ 195 ] * xx [
198 ] + xx [ 98 ] * xx [ 185 ] ; xx [ 188 ] = xx [ 210 ] + xx [ 194 ] * ( xx
[ 172 ] - xx [ 76 ] * xx [ 211 ] ) * xx [ 194 ] + xx [ 139 ] + xx [ 139 ] +
xx [ 98 ] * xx [ 178 ] + xx [ 198 ] * xx [ 186 ] ; xx [ 139 ] = xx [ 188 ] *
xx [ 192 ] - xx [ 193 ] * xx [ 187 ] ; xx [ 172 ] = xx [ 153 ] * xx [ 205 ] +
xx [ 119 ] * xx [ 201 ] ; xx [ 186 ] = xx [ 153 ] * xx [ 84 ] + xx [ 119 ] *
xx [ 207 ] ; xx [ 194 ] = xx [ 202 ] * xx [ 198 ] ; xx [ 196 ] = xx [ 119 ] *
xx [ 166 ] - xx [ 191 ] * xx [ 153 ] ; xx [ 166 ] = xx [ 98 ] * xx [ 196 ] ;
xx [ 191 ] = xx [ 35 ] * xx [ 198 ] ; xx [ 197 ] = xx [ 153 ] * xx [ 172 ] -
xx [ 119 ] * xx [ 186 ] + xx [ 194 ] + xx [ 166 ] + xx [ 98 ] * xx [ 191 ] ;
xx [ 213 ] = xx [ 202 ] + xx [ 200 ] ; xx [ 202 ] = xx [ 197 ] - xx [ 90 ] *
xx [ 213 ] ; xx [ 214 ] = xx [ 199 ] * xx [ 202 ] ; xx [ 215 ] = xx [ 198 ] *
xx [ 196 ] ; xx [ 216 ] = xx [ 210 ] + xx [ 153 ] * xx [ 186 ] + xx [ 119 ] *
xx [ 172 ] + xx [ 215 ] + xx [ 215 ] + xx [ 191 ] * xx [ 198 ] ; xx [ 172 ] =
xx [ 196 ] + xx [ 191 ] ; xx [ 186 ] = xx [ 216 ] - xx [ 90 ] * xx [ 172 ] ;
xx [ 191 ] = xx [ 26 ] + xx [ 35 ] ; xx [ 35 ] = xx [ 172 ] - xx [ 90 ] * xx
[ 191 ] ; xx [ 217 ] = xx [ 199 ] * xx [ 203 ] + xx [ 139 ] * xx [ 192 ] + xx
[ 193 ] * xx [ 189 ] ; xx [ 218 ] = xx [ 214 ] ; xx [ 219 ] = xx [ 214 ] ; xx
[ 220 ] = xx [ 186 ] - xx [ 90 ] * xx [ 35 ] ; ii [ 0 ] =
factorSymmetricPosDef ( xx + 217 , 2 , xx + 214 ) ; if ( ii [ 0 ] != 0 ? 1 :
0 != 0 ) * derivErr = 1 ; xx [ 196 ] = xx [ 153 ] * xx [ 22 ] + xx [ 119 ] *
xx [ 206 ] + xx [ 166 ] + xx [ 194 ] + xx [ 200 ] * xx [ 198 ] ; xx [ 22 ] =
xx [ 199 ] * xx [ 196 ] ; xx [ 119 ] = xx [ 212 ] + xx [ 178 ] ; xx [ 153 ] =
xx [ 119 ] * xx [ 192 ] - xx [ 193 ] * xx [ 195 ] ; xx [ 166 ] = xx [ 199 ] *
xx [ 213 ] ; xx [ 221 ] = xx [ 22 ] ; xx [ 222 ] = xx [ 186 ] ; xx [ 223 ] =
xx [ 203 ] ; xx [ 224 ] = xx [ 202 ] ; xx [ 225 ] = xx [ 139 ] ; xx [ 226 ] =
xx [ 34 ] ; xx [ 227 ] = xx [ 189 ] ; xx [ 228 ] = xx [ 34 ] ; xx [ 229 ] = -
xx [ 153 ] ; xx [ 230 ] = xx [ 34 ] ; xx [ 231 ] = xx [ 166 ] ; xx [ 232 ] =
xx [ 35 ] ; solveSymmetricPosDef ( xx + 217 , xx + 221 , 2 , 6 , xx + 233 ,
xx + 214 ) ; xx [ 178 ] = xx [ 153 ] * xx [ 239 ] ; xx [ 194 ] = - ( xx [ 166
] * xx [ 239 ] + xx [ 35 ] * xx [ 240 ] ) ; xx [ 200 ] = xx [ 26 ] + xx [ 185
] ; xx [ 26 ] = - ( xx [ 166 ] * xx [ 241 ] + xx [ 35 ] * xx [ 242 ] ) ; xx [
221 ] = xx [ 190 ] - xx [ 189 ] * xx [ 239 ] ; xx [ 222 ] = xx [ 184 ] + xx [
178 ] ; xx [ 223 ] = xx [ 194 ] ; xx [ 224 ] = xx [ 195 ] + xx [ 178 ] ; xx [
225 ] = xx [ 200 ] + xx [ 153 ] * xx [ 241 ] ; xx [ 226 ] = xx [ 26 ] ; xx [
227 ] = xx [ 194 ] ; xx [ 228 ] = xx [ 26 ] ; xx [ 229 ] = xx [ 191 ] - ( xx
...
0 != 0 ) * derivErr = 1 ; xx [ 293 ] = xx [ 27 ] ; xx [ 294 ] = xx [ 30 ] ;
xx [ 295 ] = xx [ 25 ] ; xx [ 296 ] = xx [ 32 ] ;
pm_math_Quaternion_inverseXform_ra ( xx + 293 , xx + 4 , xx + 300 ) ; xx [ 2
] = xx [ 300 ] + state [ 24 ] ; xx [ 25 ] = xx [ 1 ] * xx [ 24 ] * xx [ 29 ]
; xx [ 24 ] = xx [ 25 ] * state [ 23 ] ; xx [ 27 ] = xx [ 301 ] - xx [ 24 ] ;
xx [ 30 ] = xx [ 27 ] * xx [ 81 ] ; xx [ 32 ] = xx [ 2 ] * xx [ 81 ] ; xx [
41 ] = xx [ 2 ] - xx [ 1 ] * ( xx [ 30 ] * xx [ 31 ] + xx [ 32 ] * xx [ 81 ]
) ; xx [ 45 ] = xx [ 27 ] + xx [ 1 ] * ( xx [ 32 ] * xx [ 31 ] - xx [ 30 ] *
xx [ 81 ] ) ; xx [ 30 ] = xx [ 1 ] * xx [ 29 ] * xx [ 29 ] ; xx [ 29 ] =
state [ 23 ] * ( xx [ 30 ] - xx [ 0 ] ) ; xx [ 32 ] = xx [ 302 ] + xx [ 29 ]
; xx [ 157 ] = xx [ 32 ] + state [ 26 ] ; xx [ 303 ] = xx [ 41 ] ; xx [ 304 ]
= xx [ 45 ] ; xx [ 305 ] = xx [ 157 ] ; xx [ 161 ] = xx [ 77 ] * xx [ 157 ] ;
xx [ 165 ] = xx [ 75 ] * xx [ 157 ] ; xx [ 185 ] = xx [ 75 ] * xx [ 45 ] - xx
[ 41 ] * xx [ 77 ] ; xx [ 306 ] = xx [ 161 ] ; xx [ 307 ] = - xx [ 165 ] ; xx
[ 308 ] = xx [ 185 ] ; pm_math_Vector3_cross_ra ( xx + 303 , xx + 306 , xx +
354 ) ; xx [ 206 ] = xx [ 60 ] * xx [ 355 ] ; xx [ 221 ] = xx [ 60 ] * xx [
354 ] ; xx [ 222 ] = xx [ 73 ] * state [ 28 ] ; xx [ 227 ] = xx [ 157 ] +
state [ 28 ] ; xx [ 297 ] = xx [ 157 ] + xx [ 227 ] ; xx [ 357 ] = xx [ 0 ] ;
xx [ 358 ] = xx [ 34 ] ; xx [ 359 ] = xx [ 34 ] ; xx [ 360 ] = xx [ 34 ] ; xx
[ 361 ] = xx [ 34 ] ; xx [ 362 ] = - xx [ 78 ] ; xx [ 363 ] = xx [ 34 ] ; xx
[ 298 ] = 0.9999991678125799 ; xx [ 364 ] = - state [ 3 ] ; xx [ 365 ] = -
state [ 4 ] ; xx [ 366 ] = - state [ 5 ] ; xx [ 367 ] = - state [ 6 ] ;
...
[ 13 ] = xx [ 242 ] ; xx [ 14 ] = xx [ 244 ] ; xx [ 6 ] = xx [ 58 ] - (
pm_math_Vector3_dot_ra ( xx + 3 , xx + 38 ) + pm_math_Vector3_dot_ra ( xx +
12 , xx + 19 ) ) ; xx [ 3 ] = xx [ 40 ] + xx [ 2 ] * xx [ 192 ] + xx [ 29 ] ;
xx [ 4 ] = xx [ 19 ] + xx [ 193 ] * xx [ 2 ] + xx [ 27 ] - xx [ 198 ] * xx [
3 ] ; xx [ 5 ] = xx [ 20 ] + xx [ 66 ] - xx [ 98 ] * xx [ 3 ] ; xx [ 12 ] =
xx [ 5 ] * xx [ 182 ] ; xx [ 13 ] = xx [ 4 ] * xx [ 182 ] ; xx [ 14 ] = xx [
4 ] - xx [ 1 ] * ( xx [ 12 ] * xx [ 122 ] + xx [ 13 ] * xx [ 182 ] ) ; xx [ 4
] = xx [ 5 ] + xx [ 1 ] * ( xx [ 13 ] * xx [ 122 ] - xx [ 12 ] * xx [ 182 ] )
; xx [ 5 ] = xx [ 50 ] - ( xx [ 3 ] * xx [ 211 ] + xx [ 14 ] * xx [ 177 ] -
xx [ 4 ] * xx [ 48 ] ) ; xx [ 12 ] = xx [ 3 ] + xx [ 5 ] ; xx [ 3 ] = xx [ 14
] + xx [ 67 ] * xx [ 5 ] + xx [ 73 ] + xx [ 180 ] * xx [ 12 ] ; xx [ 13 ] =
xx [ 4 ] + xx [ 74 ] - xx [ 179 ] * xx [ 12 ] ; xx [ 4 ] = xx [ 13 ] * xx [
170 ] ; xx [ 14 ] = xx [ 3 ] * xx [ 170 ] ; xx [ 15 ] = xx [ 72 ] - ( xx [ 12
] * xx [ 173 ] + ( xx [ 3 ] - xx [ 1 ] * ( xx [ 4 ] * xx [ 154 ] + xx [ 14 ]
* xx [ 170 ] ) ) * xx [ 167 ] + ( xx [ 13 ] - xx [ 1 ] * ( xx [ 4 ] * xx [
170 ] - xx [ 14 ] * xx [ 154 ] ) ) * xx [ 169 ] ) ; xx [ 12 ] = xx [ 140 ] ;
xx [ 13 ] = xx [ 142 ] ; xx [ 14 ] = xx [ 144 ] ;
pm_math_Quaternion_inverseXform_ra ( xx + 293 , xx + 35 , xx + 19 ) ; xx [ 38
] = xx [ 146 ] ; xx [ 39 ] = xx [ 148 ] ; xx [ 40 ] = xx [ 150 ] ;
pm_math_Vector3_cross_ra ( xx + 35 , xx + 275 , xx + 41 ) ; xx [ 35 ] = xx [
32 ] + xx [ 41 ] ; xx [ 36 ] = xx [ 0 ] + xx [ 42 ] ; xx [ 37 ] = xx [ 11 ] +
xx [ 43 ] ; pm_math_Quaternion_inverseXform_ra ( xx + 293 , xx + 35 , xx + 41
) ; xx [ 0 ] = xx [ 69 ] - ( pm_math_Vector3_dot_ra ( xx + 12 , xx + 19 ) +
pm_math_Vector3_dot_ra ( xx + 38 , xx + 41 ) ) ; xx [ 11 ] = xx [ 141 ] ; xx
[ 12 ] = xx [ 143 ] ; xx [ 13 ] = xx [ 145 ] ; xx [ 35 ] = xx [ 147 ] ; xx [
36 ] = xx [ 149 ] ; xx [ 37 ] = xx [ 151 ] ; xx [ 3 ] = xx [ 70 ] - (
pm_math_Vector3_dot_ra ( xx + 11 , xx + 19 ) + pm_math_Vector3_dot_ra ( xx +
35 , xx + 41 ) ) ; xx [ 4 ] = xx [ 21 ] + xx [ 0 ] * xx [ 92 ] + xx [ 24 ] ;
xx [ 11 ] = xx [ 41 ] + xx [ 93 ] * xx [ 0 ] + xx [ 25 ] - xx [ 99 ] * xx [ 4
] ; xx [ 12 ] = xx [ 42 ] + xx [ 82 ] - xx [ 100 ] * xx [ 4 ] ; xx [ 13 ] =
xx [ 12 ] * xx [ 81 ] ; xx [ 14 ] = xx [ 11 ] * xx [ 81 ] ; xx [ 17 ] = xx [
11 ] - xx [ 1 ] * ( xx [ 13 ] * xx [ 31 ] + xx [ 14 ] * xx [ 81 ] ) ; xx [ 11
] = xx [ 12 ] + xx [ 1 ] * ( xx [ 14 ] * xx [ 31 ] - xx [ 13 ] * xx [ 81 ] )
; xx [ 12 ] = xx [ 65 ] - ( xx [ 4 ] * xx [ 118 ] + xx [ 17 ] * xx [ 71 ] -
xx [ 11 ] * xx [ 61 ] ) ; xx [ 13 ] = xx [ 4 ] + xx [ 12 ] ; xx [ 4 ] = xx [
17 ] + xx [ 67 ] * xx [ 12 ] + xx [ 372 ] + xx [ 77 ] * xx [ 13 ] ; xx [ 14 ]
= xx [ 11 ] + xx [ 378 ] - xx [ 75 ] * xx [ 13 ] ; xx [ 11 ] = xx [ 14 ] * xx
[ 60 ] ; xx [ 17 ] = xx [ 4 ] * xx [ 60 ] ; xx [ 19 ] = xx [ 206 ] - ( xx [
13 ] * xx [ 79 ] + ( xx [ 4 ] - xx [ 1 ] * ( xx [ 11 ] * xx [ 46 ] + xx [ 17
] * xx [ 60 ] ) ) * xx [ 56 ] + ( xx [ 14 ] - xx [ 1 ] * ( xx [ 11 ] * xx [
60 ] - xx [ 17 ] * xx [ 46 ] ) ) * xx [ 59 ] ) ; deriv [ 0 ] = state [ 7 ] ;
deriv [ 1 ] = state [ 8 ] ; deriv [ 2 ] = state [ 9 ] ; deriv [ 3 ] = xx [ 7
] ; deriv [ 4 ] = xx [ 8 ] ; deriv [ 5 ] = xx [ 9 ] ; deriv [ 6 ] = xx [ 10 ]
; deriv [ 7 ] = xx [ 16 ] ; deriv [ 8 ] = xx [ 18 ] ; deriv [ 9 ] = xx [ 23 ]
; deriv [ 10 ] = xx [ 26 ] ; deriv [ 11 ] = xx [ 28 ] ; deriv [ 12 ] = xx [
30 ] ; deriv [ 13 ] = state [ 15 ] ; deriv [ 14 ] = state [ 16 ] ; deriv [ 15
] = xx [ 2 ] ; deriv [ 16 ] = xx [ 6 ] ; deriv [ 17 ] = state [ 18 ] ; deriv
[ 18 ] = xx [ 5 ] ; deriv [ 19 ] = state [ 20 ] ; deriv [ 20 ] = xx [ 15 ] ;
deriv [ 21 ] = state [ 23 ] ; deriv [ 22 ] = state [ 24 ] ; deriv [ 23 ] = xx
[ 0 ] ; deriv [ 24 ] = xx [ 3 ] ; deriv [ 25 ] = state [ 26 ] ; deriv [ 26 ]
= xx [ 12 ] ; deriv [ 27 ] = state [ 28 ] ; deriv [ 28 ] = xx [ 19 ] ;
errorResult [ 0 ] = xx [ 34 ] ; xx [ 1 ] = 0.0 ; output [ 2 ] = xx [ 15 ] ;
output [ 5 ] = xx [ 2 ] ; output [ 8 ] = xx [ 6 ] ; output [ 11 ] = xx [ 5 ]
; output [ 14 ] = xx [ 19 ] ; output [ 17 ] = xx [ 0 ] ; output [ 20 ] = xx [
3 ] ; output [ 23 ] = xx [ 12 ] ; output [ 24 ] = input [ 7 ] ; return NULL ;
}
