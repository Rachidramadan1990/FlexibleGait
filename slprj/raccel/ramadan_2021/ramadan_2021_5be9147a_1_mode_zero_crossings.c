...
const NeZCData * ramadan_2021_5be9147a_1_ZCData = NULL ; PmfMessageId
ramadan_2021_5be9147a_1_computeAsmModeVector ( const double * input , const
...
ramadan_2021_5be9147a_1_computeSimModeVector ( const double * input , const
double * inputDot , const double * inputDdot , int * modeVector , double *
errorResult , NeuDiagnosticManager * neDiagMgr ) { ( void ) input ; ( void )
inputDot ; ( void ) inputDdot ; ( void ) modeVector ; ( void ) neDiagMgr ;
errorResult [ 0 ] = 0.0 ; return NULL ; } PmfMessageId
ramadan_2021_5be9147a_1_computeZeroCrossings ( const
